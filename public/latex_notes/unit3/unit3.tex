...
Motivated by this, we define the \dfn{correlation coefficient} \(\rho\) as this regression slope:
\[
...
\[
Y \mid X \sim {\rm Normal}(\rho X, \, 1 - \rho^2),
\]
...
\begin{exercise}[Estimating slope \ding{111}]
\begin{enumerate}
...
\end{exercise} 
 ...
 % ------------------------------------------------------------------------------------------------------------------------------------------
\begin{exercise}[Linear regression model parameters \ding{111}]
...
\end{exercise}
 ...
 % ------------------------------------------------------------------------------------------------------------------------------------------
\begin{exercise}[Swapping response and predictor variables]
...
\textbf{Unit 3 Extra Practice 1}  
\paragraph{}
Consider a random variable \(Y\) from a Normal distribution \( Y \sim \text{Normal}(\mu, \sigma^2) \). We define the following estimator of the mean:

\[
\hat{\mu_2} = \frac{Y_1 - 3Y_2}{2}
\]

\begin{enumerate}
  \item[(a)] Is \( \hat{\mu_2} \) biased and consistent?  
  \item[(b)] What is the sample distribution of \( \hat{\mu_2} \)?
\end{enumerate}

\paragraph{}

\textbf{Unit 3 Extra Practice 2}  
Consider the regression model for predicting earnings based on years of experience:
...
\begin{enumerate}
  \item[(a)] Calculate the covariance between years of experience and earnings, and explain how it relates to the regression slope \( \beta_1 \).  
  \item[(b)] Interpret the covariance in the context of this model.
\end{enumerate}
